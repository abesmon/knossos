(component
  (core module $guest
    ...
    (func (export "create") (result i32) i32.const 7)
    (func (export "mount") (param i32) (result i32) i32.const 0)
    (func (export "event") (param i32 i32 i32) (result i32) unreachable)
    (func (export "unmount") (param i32) (result i32) unreachable))
