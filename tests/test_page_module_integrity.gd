...
func _test_same_origin() -> void:
	...
	var result := PageModuleIntegrity.verify(module, "https://example.test/page",
	...
	result = PageModuleIntegrity.verify(module, "https://example.test/page",
...
func _test_cross_origin() -> void:
	...
	module.integrity = PageModuleIntegrity.sri_sha256(_bytes)
	result = PageModuleIntegrity.verify(module, "https://example.test/page",
			"https://cdn.test/code.vrmod", _bytes)
...
func _test_inline() -> void:
	var result := PageModuleIntegrity.verify({"kind": "inline"},
