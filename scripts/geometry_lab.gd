class_name GeometryLab
extends RefCounted

## Экспериментальная фаза геометрии (вид сверху) — площадка для отладки алгоритма
## ФОРМ комнат. Это НЕ продакшн: рабочая раскладка живёт в world_generator.gd
## («кварталы на сетке», квадратные комнаты). Здесь обкатывается идея давать комнатам
## нерегулярную форму из пентамино и раскладывать их примыканием от корня.
##
...
##
## Выход — Dictionary раскладки (см. build), который рисует GeometryTopView.
