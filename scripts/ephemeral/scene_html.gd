...
# ============================================================================
#  ЕДИНЫЙ ДОКУМЕНТ СЦЕНЫ: слитый <vrweb> (страница + эфемерный оверлей)
...
## Индекс узлов страницы из блока <vrweb> документа: каждому элементу — детерминированный
...
## include_world=false даёт «флаш» — будущий <vrweb> страницы для персистенции на сервере.
