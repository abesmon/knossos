...
test_pages/
  ...
  external_script.html собирает два linked-модуля и inline-контроллер
  external_model.luau приватная модель и её типизированный endpoint
  external_tiny.luau  view-модуль, анимация и endpoint приёма данных
