# VRWML Content Policy

`VrwebContentPolicy` — единая точка локального решения перед материализацией
декларативного VRWML-контента. Это policy клиента, а не отдельный вариант словаря
стандарта: разные клиенты могут применять более жёсткие или мягкие ограничения.
