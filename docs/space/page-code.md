...
allow/block store реализованы в `Settings`, `main` и `PageScriptPermissionDialog`.
...
`tests/test_page_script_permission_dialog.tscn`.
...
definitions, а после integrity `main._authorize_page_modules` применяет пользовательскую политику
