...
| `addons/vrweb_tools/vrweb_html_scene_importer.gd` | Тонкий `EditorSceneFormatImporter` для `.html/.htm` |
| `addons/vrweb_tools/vrweb_html_scene_codec.gd` | Собирает editable `<vrweb>` и помеченный procedural preview для import cache |
